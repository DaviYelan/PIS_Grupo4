...
socket.on("mensaje_chat", (mensajeBD) => {
  ...
  `;
      ...
      /**
       * Posiciona el mensaje enviado como primera posiscion del chat,
       * Tambien emite un evento para emitirle al usuario que se le envio el mensaje,
       * que tiene un nuevo y mensaje y el mismo debe posicionarce en la parte superior de la lista de amigos.
       */
      posicionar_mi_conversacion_resiente();
    }
  }
});

const posicionar_mi_conversacion_resiente = () => {
